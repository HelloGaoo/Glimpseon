...
class MainWindow(FluentWindow):
    ...
    def initMainNavigation(self):
        ...
        self.downloadInterface.addSoftware(icon_path, "希沃白板 3", "")
        self.downloadInterface.addSoftware(icon_path, "希沃轻白板", "")
        self.downloadInterface.addSoftware(icon_path, "希沃截图", "")
        self.downloadInterface.addSoftware(icon_path, "希沃批注", "")
        self.downloadInterface.addSoftware(icon_path, "希沃计时器", "")
        self.downloadInterface.addSoftware(icon_path, "希沃放大镜", "")
        self.downloadInterface.addSoftware(icon_path, "希沃浏览器", "")
        ...
        self.downloadInterface.addSoftware(icon_path, "希沃桌面", "")
        ...
        self.downloadInterface.addSoftware(icon_path, "反馈器助手", "")
        ...
        self.downloadInterface.addSoftware(icon_path, "希沃互动签名", "")
        self.downloadInterface.addSoftware(icon_path, "希沃伪装插件", "")
        self.downloadInterface.addSoftware(icon_path, "远程互动课堂", "")
        self.downloadInterface.addSoftware(icon_path, "希沃随机抽选", "")
        ...
        self.downloadInterface.addSoftware(icon_path, "触摸服务程序", "")
        self.downloadInterface.addSoftware(icon_path, "触摸框测试程序", "")
        self.downloadInterface.addSoftware(icon_path, "AGC 解锁工具", "")
        
        self.downloadInterface.addSection("其他工具")
        self.downloadInterface.addSoftware(icon_path, "剪辑师", "")
        self.downloadInterface.addSoftware(icon_path, "知识胶囊", "")
        self.downloadInterface.addSoftware(icon_path, "掌上看班", "")
        self.downloadInterface.addSoftware(icon_path, "ikun 启动图", "")
        self.downloadInterface.addSoftware(icon_path, "白板去除横幅", "")
        self.downloadInterface.addSoftware(icon_path, "班级优化大师", "")
