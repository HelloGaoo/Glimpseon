// classlively_native/src/hook.cpp
...
void classlively_native::install_hook() {
...
void classlively_native::uninstall_hook() {
    if (g_keyboard_hook) {
...
bool classlively_native::was_page_operation_recent(int ms_threshold) {
